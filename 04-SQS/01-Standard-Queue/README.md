...
1. No terminal do CLoud 9 IDE criado no codespaces execute o comando `cd /workspaces/FIAP-Autoglass-Serverless/04-SQS/01-Standard-Queue/` para entrar na pasta que fara este exercicio.
